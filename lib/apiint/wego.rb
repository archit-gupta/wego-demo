module Apiint
  class Wego
    ...
    def callapi(params)
      ...
      #uri = URI('http://api.wego.com/flights/api/k/2/searches?api_key=e16ecfbf7f96a9f56345&ts_code=1d9aa')
      #res = Net::HTTP.post_form(uri, data.to_json, headers)
